...
local sets = {
    ...
    Idle_Priority = {
        ...
        Body = {'Vermillion Cloak', 'Black Cloak'},
        Hands = {'Wizard\'s Gloves', 'Errant Cuffs'},
        Ring1 = {'Eremite\'s Ring', 'Zircon Ring', 'Diamond Ring'},
        Ring2 = {'Astral Ring'},
        Back = {'Rainbow Cape'},
    ...
    Resting = {
        Main = {'Pilgrim\'s Wand', 'Pluto\'s Staff'},
        Head = {'Seer\'s Crown +1', 'Gold Hairpin', 'Wizard\'s Petasos'},
        Neck = {'Checkered Scarf'},
        Body = {'Seer\'s Tunic +1', 'Errant Hpl.'},
        Hands = {'Wizard\'s Gloves'},
        Back = {'Rainbow Cape'},
        Waist = {'Friar\'s Rope', 'Penitent\'s Rope'},
        Legs = {'Baron\'s Slops'},
        Feet = {'Sorcerer\'s Sabots'},
    },
    DarkMagic = {
        ...
        Ring1 = {'Eremite\'s Ring', 'Zircon Ring', 'Diamond Ring'},
        Ring2 = {'Eremite\'s Ring', 'Zircon Ring', 'Diamond Ring'},
        Back = {'Black Cape +1'},
        Waist = {'Penitent\'s Rope'},
    ...
    nuke_Priority = {
        ...
        Body = {'Igqira Weskit'},
        Hands = {'Wizard\'s Gloves'},
        Ring1 = {'Diamond Ring', 'Zircon Ring', 'Eremite\'s Ring'},
        Ring2 = {'Diamond Ring', 'Zircon Ring', 'Eremite\'s Ring'},
        Back = {'Rainbow Cape'},
        Waist = {'Penitent\'s Rope'},
        Legs = {'Errant Slops'},
        Feet = {'Sorcerer\'s Sabots'},
    ...
    nuke_Priority = {
        ...
        Ear2 = {'Cunning Earring'},
        Body = {'Igqira Weskit', 'Black Cotehardie'},
        Hands = {'Wizard\'s Gloves'},
        Ring1 = {'Zircon Ring'},
        Ring2 = {'Zircon Ring'},
    ...
    -- itemnames = {
    --     Main = 'Asklepios', 'Rose Wand +1', 'Dark Staff',
    --     Ammo = 'Phtm. Tathlum',
...
profile.HandleMidcast = function()
    ...
    elseif (action.Skill == 'Dark Magic') then
        ...
        elseif (DrainAspir:contains(action.Name)) then
            ...
            if (player.MPP <50 and environment.DayElement == 'Dark') then -- Need to do Calc MaxMP - AspirValue
                print('Current HP % : ' .. player.MPP ..'%..  Equipping Diabolos Ring');
                gFunc.EquipSet(sets.DarkMagic);
                gFunc.Equip('Ring2', 'Diabolos\'s Ring');
            end
